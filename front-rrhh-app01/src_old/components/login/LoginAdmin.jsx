...
import { usesFechLoginAdmin } from './hooks/usesFechLoginAdmin'; // Asegúrate de que la ruta sea correcta
...
export const LoginAdmin = () => {
    ...
    const handleSubmit = (event) => {
        ...
        const { user_id, name_id } = usesFechLoginAdmin({ user: email, pass: password });
        console.log(user_id, name_id);
    };
